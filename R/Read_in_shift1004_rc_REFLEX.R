#' Read In, Shift, Interp - Shifs to 1004 Pre Neon Calibration RC applied
#'
#' For use with data before neon cal on reflex system data
#' @return Interpolated and Shifted Spectra to 1004
#' @export

read_in_dev_axis <- function(rc, sys = "R"){
  #user chooses
  files <- choose.files()
